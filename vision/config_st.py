...
CONFIG = {
    ...
    # Value a regrown RigL / SET weight starts with:
    #   zero  – grown_weights_init (0)
    #   stale – the value it had when it was last pruned (its initial value
    #           if it was never active)
    'grow_init': 'zero',                  # zero | stale
